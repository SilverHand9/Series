...
public event Action EventResetHitsBuffer;
        public event Action<MeleeKey> EventInputExecute;
public event Action<bool> EventTryToCancel;
...
EventTryToCancel?.Invoke(this.LastCancelSuccessful);
...
this.EventResetHitsBuffer?.Invoke();
        }
